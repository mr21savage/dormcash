import { ArrowRight, TrendingUp, PieChart, Target, Sparkles, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0f1c] text-white">
      <nav className="fixed w-full bg-[#0a0f1c]/80 backdrop-blur-md z-50 border-b border-gray-800/50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button className="px-6 py-2.5 bg-black text-white border border-gray-700 rounded-lg font-semibold hover:bg-gray-900 transition-all duration-300 flex items-center gap-2">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M3.609 1.814L13.792 12 3.609 22.186a1.5 1.5 0 0 1-1.286-2.268l8.9-8.918L2.323 4.082A1.5 1.5 0 0 1 3.609 1.814zm16.505 2.043L4.918 12l15.196 8.143c1.16.622 2.582-.19 2.582-1.433V5.29c0-1.242-1.42-2.055-2.582-1.433z"/>
              </svg>
              Get on Google Play
            </button>
        </div>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <button className="inline-flex items-center gap-3 px-8 py-4 bg-black text-white rounded-xl font-semibold text-lg hover:bg-gray-900 transition-all duration-300 flex items-center gap-2.5">
